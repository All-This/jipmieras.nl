      ...
      case 0:
        generatedBodies.push(
          Bodies.fromVertices(randomX, randomY, cherries, {
            ...
            friction: 0.01,
            render: {
              fillStyle: selectedColor // Custom fill color for cherries
            }
          })
        );
        break;
      case 1:
        generatedBodies.push(
          Bodies.fromVertices(randomX, randomY, gianni, {
            ...
            friction: 0.0001,
            render: {
              fillStyle: selectedColor // Custom fill color for gianni
            }
          })
        );
        break;
      case 2:
        generatedBodies.push(
          Bodies.fromVertices(randomX, randomY, baby, {
            ...
            friction: 0.01,
            render: {
              fillStyle: selectedColor // Custom fill color for baby
            }
          })
        );
        break;
      case 3:
        generatedBodies.push(
          Bodies.fromVertices(randomX, randomY, flower, {
            ...
            friction: 0.01,
            render: {
              fillStyle: selectedColor // Custom fill color for flower
            }
          })
        );
        break;
      case 4:
        generatedBodies.push(
          Bodies.fromVertices(randomX, randomY, newyork, {
            ...
            friction: 0.01,
            render: {
              fillStyle: selectedColor // Custom fill color for newyork
            }
          })
        );
        break;
      case 5:
        generatedBodies.push(
          Bodies.circle(randomX, randomY, 96, {
            ...
            friction: 0.01,
            render: {
              fillStyle: selectedColor // Custom fill color for circle
            }
          })
        );
        break;
      case 6:
        generatedBodies.push(
          Bodies.fromVertices(randomX, randomY, vase, {
            ...
            friction: 0.01,
            render: {
              fillStyle: selectedColor // Custom fill color for vase
            }
          })
        );
        break;
      case 7:
        generatedBodies.push(
          Bodies.fromVertices(randomX, randomY, pretzel, {
            ...
            friction: 0.01,
            render: {
              fillStyle: selectedColor // Custom fill color for pretzel
            }
          })
        );
        break;
...
var backgrounds = ["dark","grey"];
// var backgrounds = ["tan","magenta","blue","pink","red","yellow","green","grey"];
